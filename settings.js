...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "7AIyXbIK#Gdbr5CRUEPMs5fLy4kV9-EI2wjk70-ofchz6Xn0vL5g", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94781699679",
DEV: process.env.DEV || "94781699679",
